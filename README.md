...
1. Relevamiento de oscilogramas
Permite cargar y configurar señales obtenidas a partir de oscilogramas.

2. Generador de señales CKP/CMP
Generación manual de patrones de sincronismo mediante parámetros configurables.

3. Editor / Recorte
Herramientas para visualizar, seleccionar y editar las señales.

Tecnología: Python
Aplicación: Análisis, generación y edición de señales CKP/CMP
Área: Diagnóstico electrónico automotriz / Señales de sincronismo
Estado: Proyecto privado / demostración de interfaz y funcionalidades
